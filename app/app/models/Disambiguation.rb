	...
	def createTriples (vector, nameGraph)
		...
		vector.each do | same |
			...
			if(same.empty? == false) then
				...
				graph << [ufpel.lattes+same[0][0][2].gsub("http://ufpel.edu.br/lattes", ""), disambiguation.pair+"#has_dis", disambiguation.pair+"#has_dis-"+id]
				#graph << [ufpel.lattes+same[0][0][2].gsub("http://ufpel.edu.br/lattes", ""), RDF::RDFS.label, same[0][0][3]]
				graph << [ufpel.lattes+same[0][1][2].gsub("http://ufpel.edu.br/lattes", ""), disambiguation.pair+"#has_dis", disambiguation.pair+"#has_dis-"+id]
				#graph << [ufpel.lattes+same[0][1][2].gsub("http://ufpel.edu.br/lattes", ""), RDF::RDFS.label, same[0][1][3]]
				...
				temp << [ufpel.lattes+same[0][0][2].gsub("http://ufpel.edu.br/lattes", ""), disambiguation.pair+"#has_dis", disambiguation.pair+"#has_dis-"+id]
				#temp << [ufpel.lattes+same[0][0][2].gsub("http://ufpel.edu.br/lattes", ""), RDF::RDFS.label, same[0][0][3]]
				temp << [ufpel.lattes+same[0][1][2].gsub("http://ufpel.edu.br/lattes", ""), disambiguation.pair+"#has_dis", disambiguation.pair+"#has_dis-"+id]
				#temp << [ufpel.lattes+same[0][1][2].gsub("http://ufpel.edu.br/lattes", ""), RDF::RDFS.label, same[0][1][3]]
